...
def gen_grid_multi_zoom(shapefile, min_zoom=1, max_zoom=7):
    # Load ICES shapefile
    df = gpd.read_file(shapefile)

    for resolution in range(min_zoom, max_zoom + 1):
...
if __name__ == "__main__":
    gen_grid_multi_zoom(
        "./data/shapefiles/ICES_ecoregions/ICES_ecoregions_20171207_erase_ESRI.shp", min_zoom=8, max_zoom=8)
